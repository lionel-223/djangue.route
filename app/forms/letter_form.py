...
class LetterForm(FlaskForm):
    ...
    body = TextAreaField("Letter body", validators=[DataRequired(), Length(min=120)])
    ...
    specific_recipient_id = SelectField("I want my letter to be sent to :")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.language_code.choices = [
            (language.code, str(language)) for language in db.session.query(Language).filter_by(accept_letters=True)
        ]
        ...
        self.author_country_code.choices = [
